...
OVR6048_CONFIG = os.path.join(PKG_SHARE, 'config', 'ovr6048k1-v_manipulator_config.yaml')
OVR6048_WMX_PARAM_FILE = os.path.join(PKG_SHARE, 'config', 'ovr6048k1-v_wmx_parameters.xml')
...
def generate_launch_description():
    ...
    start_wmx_r2_general_nodes = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            'config_file': OVR6048_CONFIG,
            'wmx_param_file': OVR6048_WMX_PARAM_FILE,
        }.items(),
    )
    ...
    start_joint_state_broadcaster = LifecycleNode(
        ...
        namespace='',
        parameters=[OVR6048_CONFIG, {'use_sim_time': use_sim_time}],
        output='screen',
        emulate_tty=True,
    )
    ...
    #     namespace='',
    #     parameters=[OVR6048_CONFIG, {'use_sim_time': use_sim_time}],
    #     additional_env={'MANIPULATOR_MODEL': 'ovr6048k1-v'},
    #     output='screen',
    #     emulate_tty=True,
    # )
